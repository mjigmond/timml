'''
mlwell.py contains the Well class
...
class Well(Element):
    ...
    - pylayers: list of Python layer numbers (one less than layer numbers)
    - NscreenedLayers: number of aquifers well is screend in
    - coef: coefficients
    All attributes from element.
    '''
    Rconvsq = 7 * 7
    def __init__(self,modelParent,xw,yw,Qw,rw,layers=[1],label=None):
