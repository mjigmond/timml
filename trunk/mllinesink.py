'''
mllinesink.py contains the LineSink and HeadLineSink classes.
...
class LineSink(Element):
    def __init__(self,modelParent,x1,y1,x2,y2,sigma,layers=[1],aquiferParentFixed=None,addToModel=1,label=None):
...
class HeadLineSink(LineSink):
    def __init__(self,modelParent,x1,y1,x2,y2,head,layers=[],aquiferParentFixed=None,label=None):
...
class ResLineSink(LineSink):
    def __init__(self,modelParent,x1,y1,x2,y2,head,res,width,layers=[1],label=None,bottomelev=None):  
...
class LineSinkDitch(Element):
    def __init__(self,modelParent,xylist,Q,res,width,layers=[1],addToModel=1,label=None,aquiferParentFixed=None):
	Element.__init__(self,modelParent)
	if addToModel:
            self.modelParent.addElement(self)
...
class LineSinkDitchNew(Element):
    ...
    def __init__(self,modelParent,xylist,Q,res,width,layers=1,addToModel=1,label=None,aquiferParentFixed=None,xoffset = 0.0):
	Element.__init__(self,modelParent)
	if addToModel:
            self.modelParent.addElement(self)
        self.NLS = len(xylist) - 1
